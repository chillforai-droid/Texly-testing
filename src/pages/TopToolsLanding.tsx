    ...
    <>
      ...
      <style>{`
        .ttl-hero {
          ...
          color: white; padding: 64px 24px 52px; text-align: center; position: relative; overflow: hidden;
        }
        .ttl-hero::before {
        ...
        .ttl-super-badge {
          ...
          text-transform: uppercase; letter-spacing: 1.5px; color: #60a5fa; margin-bottom: 24px;
        }
        .ttl-hero h1 {
          font-size: clamp(30px, 5vw, 56px); font-weight: 900; line-height: 1.05;
          letter-spacing: -1.5px; margin-bottom: 20px;
        }
        .ttl-hero h1 em { color: #60a5fa; font-style: normal; }
        .ttl-hero h1 strong { color: #34d399; font-weight: 900; }
        .ttl-hero p { font-size: 17px; color: #94a3b8; max-width: 560px; margin: 0 auto 36px; line-height: 1.65; }
        .ttl-trust-row { display: flex; flex-wrap: wrap; justify-content: center; gap: 12px; }
        .ttl-trust-chip {
          display: flex; align-items: center; gap: 8px;
          background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.1);
          padding: 8px 16px; border-radius: 100px; font-size: 13px; color: #cbd5e1; font-weight: 500;
        }
        ...
        .ttl-section-title { font-size: clamp(22px, 3vw, 32px); font-weight: 800; letter-spacing: -0.5px; color: #0f172a; margin-bottom: 6px; }
        .dark .ttl-section-title { color: #f1f5f9; }
        .ttl-section-sub { font-size: 16px; color: #64748b; margin-bottom: 40px; }
        .dark .ttl-section-sub { color: #94a3b8; }

        .ttl-tools-list { display: flex; flex-direction: column; gap: 24px; margin-bottom: 40px; }
        .ttl-tool-card {
        ...
        .ttl-tool-meta { flex: 1; min-width: 0; }
        .ttl-tool-badge {
          display: inline-block; font-size: 9px; font-weight: 800; letter-spacing: 1.5px;
          text-transform: uppercase; padding: 2px 8px; border-radius: 4px;
          margin-bottom: 6px;
        }
        .ttl-tool-name { font-size: 20px; font-weight: 800; color: #0f172a; margin-bottom: 4px; letter-spacing: -0.3px; }
        .dark .ttl-tool-name { color: #f1f5f9; }
        .ttl-tool-tagline { font-size: 13px; font-weight: 600; color: #64748b; margin-bottom: 10px; }
        .dark .ttl-tool-tagline { color: #94a3b8; }
        .ttl-tool-desc { font-size: 14px; color: #475569; line-height: 1.65; }
        .dark .ttl-tool-desc { color: #94a3b8; }
        .ttl-tool-body { padding: 0 24px 24px; display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-end; }
        .ttl-use-list { flex: 1; min-width: 200px; }
        .ttl-use-title { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; color: #94a3b8; margin-bottom: 8px; }
        .ttl-use-chips { display: flex; flex-wrap: wrap; gap: 6px; }
        .ttl-use-chip {
        ...
        .ttl-tool-cta {
          ...
          text-decoration: none; color: white; transition: all 0.15s; white-space: nowrap;
          align-self: flex-end;
        }
        .ttl-tool-cta:hover { opacity: 0.9; transform: translateY(-1px); }

        .ttl-badges-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 16px; margin: 0 0 56px; }
        .ttl-badge-card {
        ...
        .ttl-badge-icon { font-size: 28px; flex-shrink: 0; }
        .ttl-badge-label { font-weight: 700; font-size: 15px; color: #0f172a; margin-bottom: 2px; }
        .dark .ttl-badge-label { color: #f1f5f9; }
        .ttl-badge-sub { font-size: 12px; color: #64748b; }
        .dark .ttl-badge-sub { color: #94a3b8; }

        .ttl-faq-section { padding: 0 0 56px; }
        .ttl-faq-wrap { background: #fff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; }
        ...
        .ttl-faq-q {
          ...
          color: #0f172a; gap: 16px;
        }
        .dark .ttl-faq-q { color: #f1f5f9; }
        .ttl-faq-a { padding: 0 24px 18px; font-size: 14px; color: #475569; line-height: 1.7; }
        .dark .ttl-faq-a { color: #94a3b8; }

        .ttl-cta-banner {
          background: linear-gradient(135deg, #1e40af 0%, #3b82f6 60%, #06b6d4 100%);
          border-radius: 20px; padding: 40px 32px; text-align: center; margin-bottom: 56px; color: white;
        }
        .ttl-cta-banner h2 { font-size: clamp(22px, 3vw, 30px); font-weight: 800; margin-bottom: 12px; letter-spacing: -0.4px; }
        .ttl-cta-banner p { font-size: 15px; opacity: 0.85; margin-bottom: 24px; }
        .ttl-cta-banner a {
          display: inline-flex; align-items: center; gap: 8px;
          background: white; color: #1e40af; font-weight: 700; font-size: 15px;
          padding: 12px 28px; border-radius: 100px; text-decoration: none; transition: all 0.15s;
        }
        ...
        @media (min-width: 768px) {
          ...
          .ttl-tool-header { flex: 1; border-right: 1px solid #e2e8f0; padding: 28px; flex-direction: column; justify-content: flex-start; }
          .dark .ttl-tool-header { border-right-color: #334155; }
          .ttl-tool-body { flex: 1.4; flex-direction: column; padding: 28px; justify-content: space-between; }
        }
      `}</style>
