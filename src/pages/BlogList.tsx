    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-slate-50 dark:bg-slate-900/50">
        <div className="absolute top-0 left-0 w-full h-full opacity-40 pointer-events-none">
          <div className="hidden sm:block absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-200 dark:bg-blue-900/20 rounded-full blur-[120px]" />
          <div className="hidden sm:block absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-200 dark:bg-indigo-900/20 rounded-full blur-[120px]" />
        </div>
      ...
      <section className="bg-slate-900 py-24 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[50%] h-full opacity-10 pointer-events-none">
          <div className="hidden sm:block absolute top-[-20%] right-[-10%] w-full h-full bg-blue-500 rounded-full blur-[150px]" />
        </div>
