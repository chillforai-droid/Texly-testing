...
const additionalTools: Tool[] = [
  ...
  { id: 'text-to-list', name: 'Text to List Converter — Convert Text to Bullet, Numbered & Comma List Free ⚡', slug: 'text-to-list-converter', category: 'utility', shortDescription: 'Convert text to bullet list, numbered list, comma-separated, HTML list & more in 1 click. Free, no signup. Sort & deduplicate included.', description: 'Text to list converter free online. Turn any text into a bullet list, numbered list, alphabetical list, comma-separated values, pipe-separated list, or HTML ul/ol list in one click. Features: Sort A→Z, Remove Duplicates, Skip Blank Lines, and custom Prefix/Suffix. Perfect for organizing notes, grocery lists, to-do lists, creating HTML lists, and formatting CSV data.', icon: 'List', keywords: ['text to list converter', 'text to list converter online free', 'convert text to list', 'turn text into list online', 'bullet point generator online free', 'numbered list maker online free', 'comma separated list generator', 'html list generator online', 'text to bullet points converter', 'list maker from text online', 'convert lines to bullet list free', 'text to numbered list free'], primaryKeyword: 'text to list converter', secondaryKeywords: ['convert text to list online free', 'bullet point generator online free', 'numbered list maker', 'comma separated list generator'], example: 'Item 1\\nItem 2\\nItem 3', process: (s) => s.split(/\\r?\\n/).map(line => `• ${line}`).join('\\n') },
