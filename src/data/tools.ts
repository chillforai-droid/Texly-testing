...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: 'Remove Special Characters Online – Free Instant Tool ⚡',
    slug: 'remove-special-characters-online',
    category: 'cleaning',
    shortDescription: 'Remove @#$%! symbols from text in 1 click. Free — works for Excel, Python, databases & filenames. No signup.',
    description: 'Remove special characters from text online — free, instant, no signup. Strips @, #, $, %, !, punctuation and all non-alphanumeric symbols. Perfect for cleaning Excel data, Python strings, database entries, filenames, and URLs. Paste text, click Process, done.',
    icon: 'ShieldAlert',
    keywords: ['remove special characters online free', 'remove special characters from text online', 'special character remover', 'special characters removal', 'special characters remove', 'remove all special characters', 'special character removal', 'special characters remover', 'clean special characters', 'strip special characters free'],
    primaryKeyword: 'remove special characters online',
    secondaryKeywords: ['special character remover', 'remove special characters from text', 'special characters removal'],
    example: 'Hello! How are you? (I am fine @ home).',
    hook: 'Strip @#$%! symbols from any text — instantly free.',
...
const additionalTools: Tool[] = [
  ...
  { id: 'text-to-list', name: 'Text to List Converter – Turn Text into List Free ⚡', slug: 'text-to-list-converter', category: 'utility', shortDescription: 'Turn any text into a bulleted or numbered list instantly. Free, 1 click, no signup.', description: 'Text to list converter free online. Turn text into list — bullet points or numbered list — in one click. Paste lines, choose list style, done. Perfect for organizing notes, creating HTML lists, and formatting data for spreadsheets.', icon: 'List', keywords: ['text to list', 'text to list converter', 'turn text into list', 'convert text to list', 'text to list converter online free', 'bullet point generator tool', 'list maker online free', 'convert lines to list'], primaryKeyword: 'text to list', secondaryKeywords: ['text to list converter', 'turn text into list', 'convert text to list'], example: 'Item 1\nItem 2\nItem 3', process: (s) => s.split(/\r?\n/).map(line => `• ${line}`).join('\n') },
