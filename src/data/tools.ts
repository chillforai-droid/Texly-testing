...
export const TOOLS: Tool[] = [
  // AI TOOLS
  {
    ...
    icon: 'UserCircle2',
    keywords: ['ai face swap online free', 'face swap online free', 'face swapper tool', 'swap faces in photos ai', 'free face swap no login', 'instant face swap online', 'best ai face swapper', 'face swap photo free'],
    primaryKeyword: 'ai face swap online free',
    secondaryKeywords: ['face swap online free', 'face swapper tool', 'swap faces in photos ai'],
    process: (s) => s
  },
  {
    id: 'bg-remover',
    ...
    icon: 'ImageIcon',
    keywords: ['remove background from image free', 'background remover online free', 'remove bg from image ai', 'transparent background maker', 'ai background remover', 'remove image background online', 'free bg remover', 'remove background 1 click'],
    primaryKeyword: 'remove background from image free',
    secondaryKeywords: ['background remover online free', 'remove bg ai', 'transparent background maker'],
    process: (s) => s
  },
  {
    id: 'ai-text-suite',
    name: 'AI Text Suite — 5-in-1 Smart Text Tool Free ⚡',
    slug: 'ai-text-suite',
    category: 'ai',
    shortDescription: 'Remove special chars, Text to List, Repeater, Find-Replace, Cleaner — सब एक जगह AI से।',
    description: 'AI Text Suite is your all-in-one text processing tool powered by Groq AI. Remove special characters, convert text to list, repeat text, smart find & replace, and clean messy text — all in one place, completely free.',
    icon: 'Sparkles',
    keywords: ['ai text tool online free', 'remove special characters ai', 'text to list ai', 'text cleaner online', 'find replace ai', 'all in one text tool'],
    process: (s) => s
  },
  {
    id: 'enhancer',
    ...
    icon: 'Maximize',
    keywords: ['enhance image quality online free', 'image enhancer online free', 'fix blurry photos ai', 'photo quality enhancer', 'sharpen image online free', 'ai image enhancer', 'improve photo quality online', 'image quality increaser online'],
    primaryKeyword: 'enhance image quality online free',
    secondaryKeywords: ['image enhancer online free', 'fix blurry photos ai', 'sharpen image online free'],
    process: (s) => s
  },
  {
    id: 'compressor',
    ...
    icon: 'Zap',
    keywords: ['compress image online free', 'image compressor online free', 'reduce image size online', 'compress jpg png free', 'smart image compressor', 'reduce photo size without quality loss', 'compress image 90 percent', 'image size reducer online'],
    primaryKeyword: 'compress image online free',
    secondaryKeywords: ['image compressor online free', 'reduce image size online', 'smart image compressor'],
    process: (s) => s
  },
  {
    id: 'image-upscale',
    ...
    icon: 'Maximize',
    keywords: ['image upscale online free', 'ai image upscaler free', 'upscale image 2x 4x online', 'enhance image quality online', 'upscale photo ai free', 'image resolution booster', 'increase image resolution online free', 'image quality increaser online'],
    primaryKeyword: 'image upscale online free',
    secondaryKeywords: ['ai image upscaler free', 'upscale image 2x 4x', 'increase image resolution online free'],
    process: (s) => s
  },
  {
    id: 'image-generator',
  ...
  // ── Dev Utility Tools ──────────────────────────────────────────────────────
  {
    ...
    name: 'Robots.txt Tester — Free Robots Validator & Checker',
    slug: 'robots-txt-tester',
    category: 'ai' as const,
    shortDescription: 'Test any URL against robots.txt rules. Check Googlebot access and detect crawl blocks instantly.',
    description: 'Free robots.txt tester and validator. Paste your robots.txt content, enter a URL and bot name, and instantly see whether the crawler is allowed or blocked — with the exact matching rule highlighted.',
    icon: 'Shield',
    keywords: ['robots txt tester', 'robots txt checker', 'robots validator', 'robots analyzer', 'googlebot tester', 'crawl checker'],
    primaryKeyword: 'robots txt tester',
    secondaryKeywords: ['robots txt checker', 'robots validator', 'googlebot tester'],
    process: (s: string) => s,
  },
  {
    id: 'json-path-finder',
    name: 'JSON Path Finder — Free JSON Structure Analyzer & Path Generator',
    slug: 'json-path-finder',
    category: 'ai' as const,
    shortDescription: 'Paste JSON and explore it as an interactive tree. Click any value to copy its JSON path instantly.',
    description: 'Free JSON path finder and analyzer. Paste any JSON to get an interactive collapsible tree view. Hover any node and click to copy its full JSONPath expression in one click.',
    icon: 'FileJson',
    keywords: ['json path finder', 'json path generator', 'json structure analyzer', 'jsonpath tool', 'json tree viewer', 'json explorer'],
    primaryKeyword: 'json path finder',
    secondaryKeywords: ['json path generator', 'json structure analyzer', 'jsonpath tool'],
    process: (s: string) => s,
  },
  {
    id: 'regex-explainer',
    name: 'AI Regex Explainer — Explain & Analyze Regex Patterns Free',
    slug: 'regex-explainer',
    category: 'ai' as const,
    shortDescription: 'Paste any regex and get a token-by-token breakdown with human-readable explanations and live match highlighting.',
    description: 'Free AI-powered regex explainer. Paste any regular expression and get an instant token-by-token breakdown — anchors, quantifiers, groups, character classes — explained in plain English.',
    icon: 'Sparkles',
    keywords: ['regex explainer', 'explain regex', 'regex meaning', 'regex analyzer', 'regex parser', 'regex tester'],
    primaryKeyword: 'regex explainer',
    secondaryKeywords: ['explain regex', 'regex meaning', 'regex analyzer'],
    process: (s: string) => s,
  },
  {
    id: 'cron-expression-generator',
    name: 'Cron Expression Generator — Free Cron Builder & Parser',
    slug: 'cron-expression-generator',
    category: 'ai' as const,
    shortDescription: 'Build cron schedules visually, get human-readable explanations, use presets, and validate cron syntax instantly.',
    description: 'Free cron expression generator and parser. Build cron jobs visually, choose from 14 common presets, or paste any expression to get a plain-English explanation. Works with crontab, AWS EventBridge, GitHub Actions, Kubernetes.',
    icon: 'Clock',
    keywords: ['cron expression generator', 'cron builder', 'cron maker', 'cron parser', 'cron schedule generator', 'crontab generator'],
    primaryKeyword: 'cron expression generator',
    secondaryKeywords: ['cron builder', 'cron parser', 'crontab generator'],
    process: (s: string) => s,
  },
  {
    id: 'redirect-chain-checker',
    name: 'Redirect Chain Checker — Free URL Redirect Path Analyzer',
    slug: 'redirect-chain-checker',
    category: 'ai' as const,
    shortDescription: 'Analyze URL redirect paths, detect redirect loops, and check HTTP status codes for SEO.',
    description: 'Free redirect chain checker. Enter any URL to trace its full redirect path with HTTP status codes (301, 302, 307, 308), detect redirect loops, measure each hop timing, and get SEO recommendations. Export results as CSV.',
    icon: 'Link2',
    keywords: ['redirect chain checker', 'redirect checker', 'url redirect checker', 'redirect path checker', '301 redirect checker', 'redirect loop detector'],
    primaryKeyword: 'redirect chain checker',
    secondaryKeywords: ['redirect checker', 'url redirect checker', 'redirect loop detector'],
    process: (s: string) => s,
  },
  ...
  },
  {
    ...
    name: 'Remove Special Characters Online — Free, Instant, No Signup ⚡',
    slug: 'remove-special-characters-online',
    category: 'cleaning',
    shortDescription: 'Strip @#$%! symbols from text in 1 click. Free — works for Excel, SQL, Python, CSV, SEO, filenames & databases. No signup needed.',
    description: 'Remove special characters from text online — free, instant, no signup. Strips @, #, $, %, !, punctuation, emojis, and all non-alphanumeric symbols. Use quick presets for Plain Text, Database/SQL, Filename Safe, or SEO Slug. Perfect for cleaning Excel data, sanitizing Python strings, preparing CSV files, generating URL slugs, and fixing text copied from PDFs. All processing is browser-side — your text is 100% private.',
    icon: 'ShieldAlert',
    keywords: ['remove special characters online free', 'remove special characters from text', 'special character remover online', 'strip special characters free', 'remove special characters from string', 'special characters removal tool', 'clean special characters from text', 'remove symbols from text online', 'remove punctuation from text online', 'special character cleaner', 'remove special chars excel', 'remove special characters python', 'sanitize text online free', 'remove non alphanumeric characters online'],
    primaryKeyword: 'remove special characters online free',
    secondaryKeywords: ['special character remover', 'remove special characters from text', 'strip symbols from text online', 'remove punctuation online free'],
    example: 'Hello! How are you? (I am fine @ home).',
    hook: 'Strip @#$%! symbols from any text — instantly, free, no login.',
    buttonText: 'Remove Special Characters',
    placeholder: 'Paste your text here — all @#$%! symbols will be removed...',
  ...
  {
    id: 'text-repeater',
    name: 'Text Repeater – Repeat Text Multiple Times Online Free ⚡',
    slug: 'text-repeater-tool',
    category: 'utility',
    shortDescription: 'Repeat any text, word, or sentence 1000+ times in 1 click. Free text repeater — no signup.',
    description: 'Text repeater tool free online. Repeat any text, word, or phrase a custom number of times instantly. Choose separator (newline, comma, space), generate thousands of repetitions in seconds. Perfect for testing, social media, data generation, and fun.',
    icon: 'Repeat',
    keywords: ['text repeater', 'text repeater tool online free', 'repeat text online', 'text multiplier', 'duplicate text multiple times', 'repeat word multiple times free', 'spam text generator', 'text repeat 1000 times'],
    primaryKeyword: 'text repeater',
    secondaryKeywords: ['text repeater tool online', 'text multiplier', 'repeat text online'],
    example: 'Repeat me!',
    process: (input, options) => {
  ...
  {
    id: 'find-replace',
    name: 'Find and Replace Text Online – Bulk Replace Free ⚡',
    slug: 'find-and-replace-text-online',
    category: 'utility',
    shortDescription: 'Find and replace any word or phrase in text instantly. Supports bulk replacements. Free, no login.',
    description: 'Find and replace text online free. Bulk replace words, phrases, or patterns in any text instantly. Supports multiple find-replace pairs at once, case-sensitive matching, and whole-word replacement. Perfect for editing documents, code, and templates.',
    icon: 'Search',
    keywords: ['find and replace online', 'find and replace text online free', 'text replace online', 'bulk replace words in text', 'online replace', 'text search and replace tool', 'mass replace text tool'],
    primaryKeyword: 'find and replace online',
    secondaryKeywords: ['find and replace text online free', 'text replace online', 'online replace'],
    example: 'The quick brown fox jumps over the lazy dog.',
    process: (input, options) => {
...
const additionalTools: Tool[] = [
  ...
  {
    id: 'text-to-list',
    name: 'Text to List Converter — Convert Text to Bullet, Numbered & Comma List Free ⚡',
    slug: 'text-to-list-converter',
    category: 'utility',
    shortDescription: 'Convert text to bullet list, numbered list, comma-separated, HTML list & more in 1 click.',
    description: 'Text to list converter free online. Turn any text into a bullet list, numbered list, or comma-separated values in one click.',
    icon: 'List',
    keywords: ['text to list converter', 'text to list converter online free', 'convert text to list', 'bullet point generator online free'],
    primaryKeyword: 'text to list converter',
    secondaryKeywords: ['convert text to list online free', 'bullet point generator online free'],
    example: 'Apple\nBanana\nCherry',
    process: (s: string, opts?: any) => {
      const lines = s.split(/\r?\n/).filter((l: string) => l.trim());
      const type = opts?.type || 'bullet';
      if (type === 'numbered') return lines.map((l: string, i: number) => (i + 1) + '. ' + l).join('\n');
      if (type === 'comma') return lines.join(', ');
      if (type === 'html-ul') return '<ul>\n' + lines.map((l: string) => '  <li>' + l + '</li>').join('\n') + '\n</ul>';
  ...
  { id: 'nato-phonetic', name: 'NATO Phonetic Alphabet Translator – Text to Alpha Bravo Free ⚡', slug: 'nato-phonetic-alphabet-translator', category: 'converter', shortDescription: 'Convert text to NATO phonetic alphabet (Alpha, Bravo, Charlie) or decode back. Free online.', description: 'NATO phonetic alphabet translator free online. Convert any text to NATO phonetic code words (Alpha, Bravo, Charlie, Delta...) or translate phonetic alphabet back to text instantly. Used by military, pilots, police, and ham radio operators. 100% free, no signup.', icon: 'Radio', keywords: ['nato phonetic alphabet translator', 'nato phonetic translator', 'nato alphabet translator', 'nato phonetic alphabet converter', 'nato code translator', 'phonetic alphabet converter online', 'spelling alphabet tool free', 'alpha bravo charlie translator', 'military phonetic alphabet online', 'nato to text'], primaryKeyword: 'nato phonetic alphabet translator', secondaryKeywords: ['nato phonetic translator', 'nato alphabet translator', 'nato code translator'], example: 'Hello', process: (s) => {
...
,
  {
    ...
    category: 'utility',
    shortDescription: 'Make WhatsApp text bold, italic, strikethrough & monospace in 1 tap. Free, mobile-friendly, no signup.',
    description: 'Free WhatsApp Text Formatter — instantly make your WhatsApp messages bold (*text*), italic (_text_), strikethrough (~text~), and monospace (`text`). Works on Android, iPhone, and WhatsApp Web. No app needed. Select text, tap a button, copy and paste. Includes 8 ready-to-use templates, live WhatsApp preview, and full formatting guide.',
    icon: 'MessageCircle',
    keywords: [
      ...
      'whatsapp styling text free',
      'bold text whatsapp android',
      'bold text whatsapp iphone',
      'whatsapp bold text generator online free',
      'how to make text bold in whatsapp',
      'whatsapp text formatter free online',
    ],
    primaryKeyword: 'whatsapp text formatter',
    secondaryKeywords: ['how to bold text in whatsapp', 'whatsapp bold text', 'whatsapp italic text', 'whatsapp strikethrough'],
    example: '*Hello!* _This is italic_ and ~this is strikethrough~.\nUse code: `SAVE50` for *50% OFF* 🎉',
    placeholder: 'Type or paste your WhatsApp message here...',
    hook: 'Make your WhatsApp messages stand out — bold, italic, strikethrough, monospace. One tap, instant copy.',
...
export const ALL_TOOLS = [...TOOLS, ...additionalTools, ...AI_TEXT_TOOLS, ...PDF_TOOLS,
  ...
  name: 'Image Format Converter – Free JPG to PNG, WebP, AVIF Online ⚡',
  slug: 'image-format-converter',
  category: 'ai' as const,
  description: 'Convert images between JPG, PNG, WebP, GIF, BMP, and AVIF formats instantly online. Batch convert up to 10 images at once. 100% browser-based — your images never leave your device. Free, no signup.',
  shortDescription: 'Convert JPG to PNG, WebP, AVIF and all image formats instantly. Batch support, quality control. 100% free & private.',
  icon: 'FileImage',
  keywords: [
