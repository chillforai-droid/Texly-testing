...
export const TOOLS: Tool[] = [
  ...
  {
    id: 'site-guard',
    name: 'SiteGuard AI – Free Website Security & Uptime Monitor 🛡️',
    slug: 'site-guard',
    category: 'ai',
    shortDescription: 'Monitor your websites for uptime, security issues & code vulnerabilities using AI. 100% free.',
    description: 'SiteGuard AI is a powerful website monitoring tool that scans your sites for downtime, broken links, security vulnerabilities, and code issues using AI. Get instant alerts and AI-powered fix suggestions. No login required.',
    icon: 'ShieldCheck',
    keywords: ['website monitor free', 'ai website security scanner', 'uptime monitor online', 'site guard tool', 'website vulnerability scanner', 'free website health check'],
    isAI: true,
    process: (s) => s,
  },
  {
