...
async function startServer() {
  ...
  app.use(helmet({
    ...
    // FIX: helmet sets X-Frame-Options: SAMEORIGIN by default which blocks
    // the site from loading inside iframes (responsive checker tools, etc.)
    // Disabling frameguard allows the site to be embedded anywhere.
    frameguard: false,
  }));
