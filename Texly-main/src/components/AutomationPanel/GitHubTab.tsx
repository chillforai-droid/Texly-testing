...
export default function GitHubTab() {
  ...
  return (
    <div className="space-y-6" id="github_pusher_tab">
      ...
      {pushStatus !== "idle" && (
        <div className="bg-slate-100 dark:bg-black/90 p-5 rounded-2xl border border-slate-200 dark:border-zinc-800 font-mono text-xs text-slate-700 dark:text-zinc-300 relative overflow-hidden space-y-4">
          <div className="flex items-center justify-between border-b border-slate-200 dark:border-zinc-800 pb-3">
            <h3 className="text-slate-700 dark:text-zinc-400 font-bold flex items-center gap-2">
